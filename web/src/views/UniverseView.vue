...
.status-strip { margin-bottom:10px; }.universe-filters { display:grid; grid-template-columns:minmax(180px,1.3fr) minmax(130px,.6fr) minmax(120px,.6fr) minmax(220px,1fr) auto; align-items:center; gap:8px; margin-bottom:12px; }.universe-filters .ant-select { width:100%; }.universe-filters > span { color:var(--muted); font:var(--type-meta) var(--font-family-mono); }.reason-field { display:grid; gap:6px; margin-top:14px; }.reason-field span,.muted { color:var(--muted); font-size:var(--type-meta); }.drawer-section { margin-top:18px; }.drawer-section h3 { margin:0 0 8px; font-size:var(--type-primary); }.metadata-note { margin-top:16px; }.audit-scroll { overflow-x:auto; }.audit-table { min-width:620px; }
