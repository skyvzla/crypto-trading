...
async function syncAndLoad() {
  await syncQuery({ ...filtersQuery.value, month: monthKey.value })
  await reload()
}
...
<template>
  <main class="operations-page calendar-page">
    <PageHeader eyebrow="OPERATIONS / DAILY PNL" title="收益日历" description="按 Asia/Shanghai 自然日查看已实现净收益；收益为空与接口异常明确区分。" :loading="loading" :refreshed-at="refreshedAt" @refresh="reload">
