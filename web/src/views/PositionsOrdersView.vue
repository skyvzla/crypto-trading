...
.result-ledger { display:flex; justify-content:space-between; gap:12px; margin:-6px 0 9px; color:var(--muted); font:10px "IBM Plex Mono",monospace; }.drawer-note,.drawer-link { margin-top:16px; }.order-link { max-width:180px; overflow:hidden; text-overflow:ellipsis; }
</style>
