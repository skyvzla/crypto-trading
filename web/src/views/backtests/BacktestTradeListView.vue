...
<template>
    <BacktestPage :title="`${symbol} 交易记录`" :eyebrow="researchId" :back-to="backTo" :crumbs="[{ label: '回测复盘', to: '/backtests' }, { label: '交易对数据', to: `/backtests/${researchId}/symbols` }, { label: symbol }]">
