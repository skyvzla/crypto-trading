...
PARAMETER_FLAGS = {
    ...
    "hard_stop_loss_pct": "--hard-stop-loss-pct",
    "hard_stop_confirm_ms": "--hard-stop-confirm-ms",
    "exit_stable_breakout_age_ms": "--exit-stable-breakout-age-ms",
    "stable_breakout_gate_stop_pct": "--stable-breakout-gate-stop-pct",
    ...
    "rise_60s_threshold": "--rise-60s-threshold",
    "rise_window_seconds": "--rise-window-seconds",
